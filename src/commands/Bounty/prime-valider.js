...
export default {
    ...
    execute: withErrorHandling(async (interaction, config, client) => {
        ...
        // Anti-abus : le poseur ne peut pas se valider sa propre prime
        ...
        // -----------------------------------------------------------
        // Mise à jour du contrat (PAS de versement Discord — tout est en jeu)
        // -----------------------------------------------------------
        ...
        // -----------------------------------------------------------
        // Embed de clôture (dans le salon)
        // -----------------------------------------------------------
        let closingPhrase = '';
        if (bounty.grade === 'or') {
        ...
        try {
            const dmEmbed = createEmbed({
                ...
                description:
                    ...
                    `💸 EL GATO va te virer **${grade.price.toLocaleString()} $** sur OneState dans les prochaines minutes/heures.\n` +
            ...
            // Si le chasseur a les MP fermés, on ignore silencieusement
            // Le staff voit toujours la confirmation dans le salon
        }
